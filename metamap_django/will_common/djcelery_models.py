...
class DjceleryIntervalschedule(models.Model):
    ...
    def __str__(self):
        return u'every ' + str(self.every) + ' ' + self.period
...
class MetamapEtl(models.Model):
    ...
    pre_sql = models.CharField(max_length=2000, blank=True, null=True)
...
class MetamapExecutions(models.Model):
    log_location = models.CharField(max_length=120)
    start_time = models.DateTimeField()
    end_time = models.DateTimeField(blank=True, null=True)
    status = models.IntegerField()
    job = models.ForeignKey(MetamapEtl, models.DO_NOTHING)
...
class MetamapMeta(models.Model):
    meta = models.CharField(unique=True, max_length=30)
...
class MetamapTblblood(models.Model):
    tbl_name = models.CharField(max_length=100)
    ...
    class Meta:
        ...
        unique_together = (('tbl_name', 'parent_tbl', 'valid'),)
